...
namespace CasCap.Data.Migrations
{
    ...
    [Migration("20260926033021_AddSelfFlagAndPollVotes")]
    partial class AddSelfFlagAndPollVotes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CasCap.Data.Entities.InboundMessageEntity", b =>
                {
                    ...
                    b.Property<string>("PollVoteOptionIndexes")
                        .HasColumnType("text")
                        .HasColumnName("poll_vote_option_indexes");

                    b.Property<long?>("PollVoteTimestamp")
                        .HasColumnType("bigint")
                        .HasColumnName("poll_vote_timestamp");
